from src.cropgen.processing.ImageBox import ImageBox
from src.cropgen.processing.TextFragment import TextFragment
...
from src.cropgen.processing.Paragraph import Paragraph
from src.cropgen.processing.helpers.helper_to_classes import (
...
from src.cropgen.processing.helpers.text_replacements import (
    replacements,
    replacements_envs,
    regex_replacements,
)
from src.cropgen.shared.default_parameters import (
    BIG_BOX_THRESHOLD,
    min_nodes_for_big_box_removal,
)
from shapely import Polygon, box as boxshape
from src.cropgen.shared.display import display
import re
